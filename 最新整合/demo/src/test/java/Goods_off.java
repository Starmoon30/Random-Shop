...
public class Goods_off {
  ...
  public void goodson() throws InterruptedException {
    ...
    driver.findElement(By.cssSelector(".el-sub-menu:nth-child(2) > .el-sub-menu__title")).click();
    Thread.sleep(500);
    driver.findElement(By.cssSelector(".el-sub-menu:nth-child(2) .el-menu-item:nth-child(2)")).click();
    Thread.sleep(500);
    driver.findElement(By.cssSelector(".el-card:nth-child(1) .el-button")).click();
    Thread.sleep(500);
  }
}
